    ...
    <div className="w-full max-w-md mx-auto">
      ...
      >
        ...
        <div>
          ...
          >
            ...
            <Input
              ...
              className="bg-white/30 border border-white/40 focus-within:border-[#006b5f] focus-within:bg-white/50 transition-all placeholder:text-gray-600 text-gray-800 backdrop-blur-sm"
            />
            <FieldError />
          </TextField>
        </div>
          ...
          <TextField isRequired className="w-full" name="password">
            <div className="flex justify-between items-center mb-1">
              ...
              <Link
                ...
                className="text-xs font-bold text-[#006b5f] hover:text-[#14b8a6] transition-colors underline decoration-transparent hover:decoration-current"
              >
                Forgot password?
              </Link>
            </div>
            <InputGroup className="rounded-xl bg-white/30 border border-white/40 focus-within:border-[#006b5f] focus-within:bg-white/50 transition-all backdrop-blur-sm">
              <InputGroup.Input
                placeholder="••••••••"
                className="w-full placeholder:text-gray-600 text-gray-800 bg-transparent"
              ...
              <InputGroup.Suffix className="pr-2">
                <Button
                  ...
                  className="text-[#006b5f] hover:bg-white/50"
                >
                  {isVisible ? (
        ...
        <div className="pt-2">
          <Button
            type="submit"
            className="w-full rounded-xl bg-linear-to-r from-[#006b5f] to-[#14b8a6] text-white font-bold shadow-lg hover:shadow-teal-500/40 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 border border-white/10"
          >
      ...
      <div className="my-6">
        <div className="flex items-center w-full">
          ...
          <span className="px-4 text-xs font-bold text-gray-600 uppercase tracking-wider">
            Or continue with
          </span>
          <hr className="flex-grow border-t border-gray-400/30" />
        </div>
      ...
      <div>
        <Button
          ...
          className="w-full rounded-xl border border-gray-300/50 bg-white/30 hover:bg-white/50 text-gray-800 font-medium hover:border-teal-300 transition-all backdrop-blur-sm"
          variant="bordered"
        >
          <Icon icon="devicon:google" className="text-lg mr-2" /> Sign in with
          Google
        </Button>
      </div>
      ...
      <div className="text-center mt-6 text-sm">
        ...
        <Link
          href="/signup"
          className="font-bold text-[#006b5f] hover:text-[#14b8a6] transition-colors ml-1 underline decoration-transparent hover:decoration-current"
        >
          Register
        </Link>
      </div>
        ...
        <section className="hidden md:flex md:w-1/2 relative items-end justify-start p-12 overflow-hidden group">
          ...
          <div className="relative z-20 text-white max-w-md">
            ...
            <p className="font-sans text-base opacity-90 leading-relaxed mb-6 drop-shadow-sm">
              Seamlessly manage your medical journey with DocAppoint's intuitive
              platform designed for both patients and providers.
            </p>
