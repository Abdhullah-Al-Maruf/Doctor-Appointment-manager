...
const features = [
  ...
  },
  {
    ...
    description:
      "We are always here for you. Our emergency department is open 24 hours a day, 7 days a week.",
    icon: (
      <svg
        className="w-8 h-8 text-teal-600"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Skip the waiting room. Book your appointment online in seconds and manage your visits easily.",
    icon: (
      <svg
        className="w-8 h-8 text-teal-600"
        fill="none"
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-slate-500 leading-relaxed">
            ...
            services with a personal touch. Your health and comfort are our top
            priorities.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature) => (
            <div
              key={feature.id}
              className="group relative p-8 rounded-2xl bg-white/60 backdrop-blur-md border border-white/60 shadow-lg shadow-slate-200/50  hover:bg-white hover:shadow-xl hover:shadow-teal-100/50 hover:-translate-y-1 transition-all duration-300 ease-out
              "
            >
              {/* Icon Container */}
              <div
