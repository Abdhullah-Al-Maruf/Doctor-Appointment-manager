...
import { FaFacebookF, FaLinkedinIn, FaInstagram, FaPaperPlane, FaPhoneAlt, FaEnvelope, FaMapMarkerAlt } from 'react-icons/fa';
...
export default function Footer() {
  return (
    <footer className="relative  w-full pt-16 pb-8 px-6 md:px-12 bg-white/60 mt-10 backdrop-blur-xl border-t border-[#14b8a6]/30 text-neutral-700 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-12">
        ...
        <div className="md:col-span-4 space-y-5">
          ...
          <p className=" max-w-sm leading-relaxed text-sm">
            Precision healthcare for a modern world. We connect you with verified specialists for seamless appointments and secure medical management.
          </p>
        ...
        <div className="md:col-span-2 space-y-5">
          <h6 className="text-sm font-bold text-gray-600 uppercase tracking-wider">Company</h6>
        ...
        {/* 3. Support Links */}
        <div className="md:col-span-2 space-y-5">
          <h6 className="text-sm font-bold text-gray-600 uppercase tracking-wider">Support</h6>
        ...
        <div className="md:col-span-4 space-y-5">
          <h6 className="text-sm font-bold text-gray-600 uppercase tracking-wider">Newsletter</h6>
          ...
          <div className="flex items-center gap-2 pt-2">
            ...
            <span className="text-xs text-neutral-500 uppercase tracking-wider">Trusted by 10k+ Patients</span>
          </div>
        </div>
        ...
        <div className="md:col-span-12 pt-1  border-t border-[#14b8a6]/10 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-xs text-neutral-700">
            ...
            <Link href="/cookies" className="hover:text-[#14b8a6] transition-colors">Cookies</Link>
          </div>
        </div>
