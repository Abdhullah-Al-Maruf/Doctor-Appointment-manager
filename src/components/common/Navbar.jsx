...
const NavigationBar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b bg-white/0 backdrop-blur-md shadow-md h-16">
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        {!user && (
          <div className="hidden lg:flex items-center gap-4">
            ...
            <Link href="/signup">
              <Button className="bg-linear-to-b from-[#006b5f] to-[#14b8a6] shadow-lg shadow-[#14b8a6]/50">
                Register
              </Button>
            </Link>
          </div>
        ...
        {user && (
          <div className="hidden lg:flex items-center ml-6 gap-1 px-2 py-3 text-sm text-gray-700">
            ...
            <Button
              ...
              className="bg-linear-to-b from-[#006b5f] to-[#14b8a6] shadow-lg shadow-[#14b8a6]/50 w-full"
            >
              Logout
            </Button>
          </div>
        ...
        <button
          ...
          className="lg:hidden p-2 text-gray-600 hover:text-teal-600 hover:bg-teal-50 rounded-md transition"
        >
          ☰
        </button>
      </div>
      ...
      <div
        className={clsx(
          "fixed overflow-hidden top-0 right-0  h-screen w-4/5 max-w-[320px] bg-white/80 backdrop-blur-2xl shadow-2xl z-50 transition-all duration-300 ease-in-out lg:hidden border-l border-white/30 flex flex-col",
      ...
      >
        ...
        <div className="p-5 pb-15 border-t border-gray-200/40 bg-white/30 backdrop-blur-md">
          {!user ? (
